        ...
        selection.each(function (df) {
           ...
           df = _.sortBy(df, "freq").reverse();
            ...
            const yScale = d3.scaleBand()
                .range([0, height - 20])
                .domain(df.map(function (d) { return d.short_meaning; }));
            ...
            div.selectAll("rect.white")
                ...
                .append("rect")
                .attr("class", "white")
                .attr("y", function (d, i) { return yScale(d.short_meaning) +  yScale.bandwidth()/2; })
            ...
            div.selectAll("text")
                ...
                .enter()
                .append("text")
                .attr("y", function (d, i) { return yScale(d.short_meaning) +  yScale.bandwidth()/2 - 10; })
                .attr("x", 0)
                .text(function(d){ return d.short_meaning })
